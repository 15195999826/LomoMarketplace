---
description: InkMon creature management (init, create, evolve, devolve, add to database)
argument-hint: init | create | evo <name> | devo <name> | add <file.json>
allowed-tools: Read, Write, Glob, Grep, Bash, mcp__inkmon-mcp__add_inkmon, mcp__inkmon-mcp__get_inkmon, mcp__inkmon-mcp__get_next_dex_number, mcp__inkmon-mcp__ping
model: sonnet
---
...
- 需要先安装 inkmon-server（见 LomoMarketplace/servers/inkmon-server/）
