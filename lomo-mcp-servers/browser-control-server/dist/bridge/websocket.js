...
import { serialize, deserialize, isTerminalInput, isTerminalResize, isBrowserResult, createTerminalOutput, createConnectionStatus, DEFAULT_WS_PORT, } from "@lomo/browser-bridge";
...
export class BridgeServer {
    ...
    setupTerminalEvents() {
        ...
        this.terminalManager.on("output", (data) => {
     ...
     * 发送浏览器控制命令并等待结果
     */
    async sendBrowserCommand(command) {
